      ...
      <aside className="border-b border-[color:var(--rule)] bg-[color:var(--surface-muted)]/55 px-4 py-5 lg:border-b-0 lg:border-r">
        ...
        <div className="mt-6 border-t border-[color:var(--rule)] pt-5">
          ...
          <div className="grid grid-cols-2 gap-2 lg:grid-cols-1">
            <button className="border border-[color:var(--accent)] bg-[color:var(--accent-soft)] px-3 py-2 text-left text-sm text-[color:var(--ink)]" type="button">
              {copy.graphView}
            </button>
            <button className="border border-[color:var(--rule)] bg-[color:var(--surface)] px-3 py-2 text-left text-sm text-[color:var(--ink-soft)]" type="button">
              {copy.listView}
            </button>
          </div>
