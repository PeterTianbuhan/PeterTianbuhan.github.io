...
const rawSiteContent: RawSiteContent = {
  ...
  projects: [
    ...
    {
      slug: "native-symphony",
      statusTone: "amber",
      logHref: "/blog/current-workflow",
      stack: ["Linear", "Codex CLI", "VPS", "GitHub PR"],
      status: { zh: "孵化中", en: "Incubating" },
      name: { zh: "Native Symphony 工作流", en: "Native Symphony Workflow" },
      summary: {
        zh: "把自然语言想法整理成 Linear 任务，由 VPS 上的 Codex 执行、审查、开 PR，并把进展回写到 Linear。",
        en: "A workflow that turns natural-language ideas into Linear tasks, runs Codex on a VPS, opens PRs, and reports progress back to Linear.",
      },
      meta: { zh: "持续打磨 - 从个人主页开始验证", en: "In progress - proven first on this homepage" },
    },
  ],
};
